...
router.get('/:userId', carrito_controller_1.carritoController.findById);
router.post('/:idProd/:userId', passport_1.default.authenticate('jwt', { session: false }), carrito_controller_1.carritoController.agregar);
